...
:setvar DefaultDataPath "D:\WORK\Microsoft SQL Server\Data\MSSQL13.MSSQLSERVER\MSSQL\DATA\"
:setvar DefaultLogPath "D:\WORK\Microsoft SQL Server\Data\MSSQL13.MSSQLSERVER\MSSQL\DATA\"
...
GO
REVOKE CONNECT TO [piotrek] CASCADE;
...
GO
PRINT N'Creating [log].[preflight_checks]...';


GO
CREATE TABLE [log].[preflight_checks] (
...
END
GO
PRINT N'Creating [log].[run_preflight_check]...';
